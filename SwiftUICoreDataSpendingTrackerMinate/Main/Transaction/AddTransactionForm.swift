...
struct AddTransactionForm: View {
        ...
        NavigationView {
            Form {
                ...
                Section(header: Text("CATEGORIES")) {
                    ...
                    ForEach(sortedByTimestampCategories) {
                        selectedCategory in
                        HStack(spacing: 12) {
                            if let data = selectedCategory.colorData, let uiColor = UIColor.color(data: data) {
    ...
    struct PhotoPickerView: UIViewControllerRepresentable {
        ...
        class Coordinator: NSObject, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
            ...
            //Be careful here because the class inside the struct
    ...
    private var saveButton: some View {
        Button {
            ...
            do {
                ...
                print("Failed to save transactions: \(customErr)")
            }
